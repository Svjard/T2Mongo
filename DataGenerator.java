...
public class DataGenerator {
  ...
  public static void setupCustomers() throws Exception {
    ...
    for (int n = 0; n < TOTAL_CUSTOMERS; n++) {
      ...
      String username = person.username(),
             ...
             created = new Date(uRandomCreated()).toLocaleString(),
             lastLogin = new Date(uRandomLogin()).toLocaleString(),
             status = "active",
  ...
  public static void setupOrders() throws Exception {
    ...
    while (iterator.hasNext()) {
      ...
      writerMC.write("INSERT INTO MyECommerce.tdMarketingCampaign VALUES(" + n + ",'Loyal Customers','" + removeLastChar(StringUtils.join(tp.paragraph(5), ",")) + "',1,cast(cast(700101 as date) + " + s.getTime() + " / 86400 as timestamp(6)) + (" + s.getTime() + " mod 86400) * interval '00:00:01' hour to second" + ",cast(cast(700101 as date) + " + e.getTime() + " / 86400 as timestamp(6)) + (" + e.getTime() + " mod 86400) * interval '00:00:01' hour to second);\n");
    ...
    while (totalQ2 <= ((totalQ1 * 0.68) / 120) * 31) {
      ...
      String query = "INSERT INTO MyECommerce.tdOrder VALUES(" + id + "," + 
        ...
        "NULL" + ",'" +
        customers.get(customer - 1).getAsJsonObject().get("address1").getAsString() + "','" +
        customers.get(customer - 1).getAsJsonObject().get("address2").getAsString() + "','" +
        customers.get(customer - 1).getAsJsonObject().get("city").getAsString() + "','" +
        ...
        customers.get(customer - 1).getAsJsonObject().get("country").getAsString() + "','" +
